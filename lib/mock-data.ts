...
export const mockChildren: Child[] = [
  {
    ...
    futureInstructions: {
      ...
      instructions: "Please ensure the funds are used for Aisha's higher education. If she decides not to pursue university, the funds can be used for vocational training or starting a small business.",
    },
  },
  {
    id: "2",
    ...
    futureInstructions: {
      guardianName: "Ahmed Rahman",
      guardianContact: "+60 12-345-6789",
      instructions: "Funds are for Yusuf's education and early career development.",
    },
  },
  {
    id: "3",
  ...
  },
  {
    ...
    futureInstructions: {
      ...
      instructions: "Omar's car fund for when he turns 18. He should have a say in the decision.",
    },
  },
]
